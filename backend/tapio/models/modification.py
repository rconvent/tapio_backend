...
class Modification(mixin.ModelSignals, models.Model):
    ...
    reduction_stategy = models.ForeignKey("ReductionStrategy", on_delete=models.CASCADE, null=False, related_name="modifications", help_text="linked reduction strategy of the modification")
